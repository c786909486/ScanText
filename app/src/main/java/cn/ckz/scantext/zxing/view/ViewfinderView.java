...
package cn.ckz.scantext.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public void setCameraType(String scan_type) {
        this.scan_type = scan_type;
        frame = CameraManager.get().getFramingRect(scan_type);
        Log.d("ViewfinderView",scan_type);
        postInvalidate();
    }
    @Override
    public void onDraw(Canvas canvas) {
        ...
        Log.d("ViewfinderView",frame.toString());
